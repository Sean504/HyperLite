...
const PLATFORM_PACKAGES = {
  'win32-x64':    { pkg: '@hyperlite-ai/hyperlite-win32-x64',    bin: 'hl.exe' },
  'linux-x64':    { pkg: '@hyperlite-ai/hyperlite-linux-x64',    bin: 'hl'     },
  'linux-arm64':  { pkg: '@hyperlite-ai/hyperlite-linux-arm64',  bin: 'hl'     },
  'darwin-arm64': { pkg: '@hyperlite-ai/hyperlite-darwin-arm64', bin: 'hl'     },
  'darwin-x64':   { pkg: '@hyperlite-ai/hyperlite-darwin-x64',   bin: 'hl'     },
};
